...
def extract_label_from_output(output_text):
    m = re.search(r"\b(SUPPORTS|REFUTES|NOT ENOUGH INFO)\b", (output_text or "").upper())
...
def run():
    ...
    precision, recall, f1, _ = precision_recall_fscore_support(
        filtered_y_true, filtered_y_pred, labels=valid_labels, zero_division=0
    )
