...
# Load Fever data and extract evidence sentences from the database
...
def run():
    ...
    # Resume from the last file if exists
    file_index = 0
    ...
    report = classification_report(y_true, y_pred, labels=valid_labels, digits=3)
    print(report)
