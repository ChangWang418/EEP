...
def run():
    ...
    precision, recall, f1, _ = classification_report, precision_recall_fscore_support(y_true, y_pred, labels=valid_labels, zero_division=0)[0:3]
