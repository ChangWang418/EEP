...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))                 # .../SCI/CoT
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, "..", ".."))    # .../SCI
...
DATA_DIR = os.path.abspath(os.path.join(BASE_DIR, "..", "Sci_data"))  # .../SCI/Sci_data
