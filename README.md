# 🧩 EEP–CoT–SelfAsk–Standard: A Comparative Framework for Fact-Checking Prompts

This project implements and compares multiple prompting strategies (**EEP**, **CoT**, **Self-Ask**, **Standard**) across three fact-checking datasets (**FEVER**, **PubHealth**, **SciFact**).  
...
│       ├── claims_dev.jsonl
│       └── corpus.jsonl
├── .env     ← API keys for OpenAI / OpenRouter
```
...
python FEVER/EEP/run_experiment_db-result-save.py
python Pubhealth/Selfask/run_experiment_db-result-save.py
python SCI/Standard/run_experiment_db-result-save.py
```
...
| Models | GPT-3.5 Turbo, LLaMA-3 8B Instruct, Qwen 3.0 v1 8B Instruct |
| Prompts | EEP, CoT, Self-Ask, Standard |
