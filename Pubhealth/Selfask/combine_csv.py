...
output_file = os.path.join(BASE_DIR, "pubhealth_dev_combined.csv")

# Iterate through all CSV files in the folder, read them, and store in a list
all_dfs = []
...
# Save as a new CSV file in the current script directory
